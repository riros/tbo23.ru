...
/////////////////////// End Global Configuration Options ////////////////////////
    ...
    togglemobile: function (action, duration) {
        ...
        if ($mobilemenu.css('visibility') == 'hidden' && (!action || action == 'open')) {
            ...
            $mobilemenu.animate({left: '-100%'}, duration, function () {
...
//calculate this sub menu's offsets from its parent
                        ...
                        $subul.css({left: menuleft, width: dimensions.subulw}).stop(true, true).animate({
                            height: 'show',
                            opacity: 'show'
                        ...
                        if (setting.shadow) {
                            ...
                            $curobj.data('$shadow').css({
                                ...
                                left: shadowleft,
                                top: shadowtop
                            }).stop(true, true).animate({height: dimensions.subulh}, smoothmenu.transition.overtime);
                        }
    ...
    init: function (setting) {
        setting.mobilemql = (window.matchMedia) ? window.matchMedia(this.mobilemediaquery) : {
            matches: false,
    ...
    (function ($) { //begin Scripted CSS Patch
        ...
        $.extend($.fn, {
            ...
            outerHeight: function (bool) {
                ...
                var val = this.innerHeight(), obj = this.get(0),
            ...
            outerWidth: function (bool) {
                ...
                var val = this.innerWidth(), obj = this.get(0),
                    getter = document.defaultView.getComputedStyle(obj, null);
